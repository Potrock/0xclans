		...
		<div className="bg-gray-900">
			...
			<section className="flex flex-col items-center px-4 py-12 md:px-24 lg:px-48 md:flex-row">
				<div className="md:w-1/2">
					...
					<p className="mb-8 text-xl text-gray-300">
						Connect your crypto wallet and video game accounts to
			...
			>
				<div className="mb-16">
					...
					<p className="text-lg">
						Take advantage of the following features when you create
						and manage your gaming clans with 0xClans:
					</p>
				</div>
				<div className="flex flex-col md:flex-row md:-mx-4">
					...
					<div className="px-4 mb-8 md:w-1/3">
						...
						<p className="text-lg">
							Enjoy the benefits of decentralized technology and
							have full control over your gaming assets, together.
						</p>
					</div>
					<div className="px-4 mb-8 md:w-1/3">
						<div className="flex items-center mb-4">
						...
						<p className="text-lg">
							Assign roles and permissions to your clan members
							and customize your clan to your liking.
						</p>
					</div>
				</div>
			</section>
